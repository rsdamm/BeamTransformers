 ...
 */
package com.plesba.beamtransformers;
...
public class WordCount {
  ...
  public interface WordCountOptions extends PipelineOptions {
    ...
    @Default.String("/home/renee/git/BeamTransformers/"
            + "kinglear.txt")
    String getInputFile();
  ...
  public static void main(String[] args) {
    ...
    System.out.println("run WordCount tests");
    ...
    System.out.println("after readlines tests1");
